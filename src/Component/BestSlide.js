...
export default function BestSlide() {
  ...
  <SwiperSlide onClick={() => {navigate('/body');window.scrollTo(0, 0); }}>
        <img src="/img/best_slide/best01.jpg"  alt="1번 베스트 상품" />

        {/* <img src="/img/best_slide/best02.jpg" className='hover' alt="1번 베스트 상품 호버" /> */}
       ...
       <SwiperSlide onClick={() => {navigate('/body');window.scrollTo(0, 0); }}>
        <img src="/img/best_slide/best02.jpg" alt="2번 베스트 상품" />
         <div className={styles.best_text}>
      ...
      <SwiperSlide onClick={() => {navigate('/body');window.scrollTo(0, 0); }}>
        <img src="/img/best_slide/best03.jpg" alt="3번 베스트 상품" />
         <div className={styles.best_text}>
       ...
       <SwiperSlide onClick={() => {navigate('/hand');window.scrollTo(0, 0); }}>
        <img src="/img/best_slide/best04.jpg" alt="4번 베스트 상품" />
         <div className={styles.best_text}>
     ...
     <SwiperSlide onClick={() => {navigate('/body');window.scrollTo(0, 0); }}>
        <img src="/img/best_slide/best05.jpg" alt="5번 베스트 상품" />
         <div className={styles.best_text}>
     ...
     <SwiperSlide onClick={() => {navigate('/hand');window.scrollTo(0, 0); }}>
        <img src="/img/best_slide/best06.jpg" alt="6번 베스트 상품" />
         <div className={styles.best_text}>
